...
export const getAllPosts=(city,street,pincode,state="",searchKeyword="")=>async(dispatch)=>{
  console.log(city,street,pincode,state,searchKeyword)
   ...
   try{
       ...
       let link="http://localhost:3000/api/post/allposts?";
       link+=query.join("&")
...
export const getMyPosts=()=>async(dispatch)=>{
   ...
   try{
       ...
       let link="http://localhost:3000/api/post/getmyposts";
...
export const getSinglePost=(id)=>async(dispatch)=>{
   ...
   try{
       ...
       let link=`http://localhost:3000/api/post/getsinglepost/${id}`;
...
export const deletePost=(id)=>async(dispatch)=>{
   ...
   try{
       let link=`http://localhost:3000/api/post/delete/${id}`;
